...
const createButtonStyles = createStyles((theme, size?: "medium" | "large" | undefined) => ({
  common: {
    height: size == "large" ? "56px" : "40px",
    borderRadius: "8px",
  },
  primary: {
    background: theme.fn.linearGradient(theme.other.litGradients.accent.deg, theme.other.litGradients.accent.from, theme.other.litGradients.accent.to),
    "&:focus": {
  ...
  secondary: {
    background: "linear-gradient(white, white) padding-box,linear-gradient(114.44deg,  #0038F5, #9F03FF) border-box",
    ...
    "&:focus": {
      outline: "none",
      background: "linear-gradient(#F0F0F0, #F0F0F0) padding-box,linear-gradient(114.44deg,  #0038F5, #9F03FF) border-box",
    },
    "&.mantine-Button-loading": {
      outline: "none",
      background: "linear-gradient(#F0F0F0, #F0F0F0) padding-box,linear-gradient(114.44deg,  #0038F5, #9F03FF) border-box",
